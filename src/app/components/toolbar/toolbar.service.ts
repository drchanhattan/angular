...
export class ToolbarService {
  public readonly hideMenuBtn = signal<boolean>(false);
  public readonly label = signal<string>('Location');
  public readonly navOpen = signal<boolean>(false);
  public readonly photoNavOpen = signal<boolean>(false);
  public nav!: MatSidenav;
  public photoNav!: MatSidenav;
  private readonly router = inject(Router);

  public readonly showPhotoMenu = toSignal(
  ...
  public setNav(sidenav: MatSidenav, navType: NavType) {
  ...
  public toggleMenu(menuType: NavType) {
  ...
  public hideOverflow(sidenav: MatSidenav) {
